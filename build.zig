...
const generated_fipsmodule_sources = &.{
    ...
    "vendor/third_party/fiat/asm/fiat_p256_adx_mul.S",
    "vendor/third_party/fiat/asm/fiat_p256_adx_sqr.S",
};

const generated_crypto_sources = &.{
    "vendor/crypto/curve25519/asm/x25519-asm-arm.S",
    "vendor/crypto/hrss/asm/poly_rq_mul.S",
    "vendor/crypto/poly1305/poly1305_arm_asm.S",
